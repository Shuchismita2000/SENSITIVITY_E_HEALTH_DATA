...
def app():
    ...
    st.markdown("""
                ...
                """)
    st.title(" Initial Analyse Attributes")
    st.markdown("""
    ...
    st.markdown("""
            ...
            """)
    st.title("Weights of Attributes")
    st.markdown("""
    ...
    with st.container():
        ...
        st.markdown("""
                ...
                **Data sensitivity** is dependent on several factors. In the proposed entropy model, we consider 
                **three factors** that contribute to data sensitivity. These factors and the reasons for using them are as follows.
    ...
    st.title("Entropy of Attributes")
    st.markdown("""
    ...
    st.title("Entropy of Associativity")
    st.markdown("""
...
other datasets, the more sensitive it is.
    ...
    st.title("Combined Entropy")
    st.markdown("""
                The combined entropy measure is the *8product of all the three entropy measures**
            """)
    ...
    st.title("Sensitivity of Attributes")
    st.markdown("""
                **Base on combined entropy** we classify the attributes are sensitive or not.We will set a **threshold**
                 which help to predict from combined entropy
            """)
